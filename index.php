...
<body class="min-h-screen p-6 sm:p-10 relative flex flex-col justify-between">
...
?>
    ...
    <div class="max-w-6xl mx-auto w-full relative z-10 mb-auto">
    ...
    <!-- ================= ส่วน Footer หน้าแรก (เพิ่มตรงนี้) ================= -->
    <footer class="max-w-6xl mx-auto w-full relative z-10 mt-12 bg-white/90 backdrop-blur-md py-4 px-6 rounded-2xl border border-white/20 text-center shadow-lg">
        <p class="text-sm text-gray-500">© 2026 ระบบจัดการเมนูอาหาร - หน้าหลักระบบ | พัฒนาด้วย PHP & Tailwind CSS</p>
    </footer>
    <!-- ====================================================================== -->
